...
const statusOptions: { value: StockStatus; label: string; color: string; range: string }[] = [
  { value: 'critical', label: 'Kritik', color: 'bg-red-500 dark:bg-red-400', range: '0-1 ay' },
  { value: 'low', label: 'Az', color: 'bg-orange-500 dark:bg-orange-400', range: '1.1-2 ay' },
  { value: 'sufficient', label: 'Yeterli', color: 'bg-green-500 dark:bg-green-400', range: '2.1+ ay' },
]

export default function MultiStatusFilter({ selectedStatuses, onChange }: MultiStatusFilterProps) {
