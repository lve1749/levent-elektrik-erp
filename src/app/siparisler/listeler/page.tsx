...
export default function ListelerPage() {
  ...
  const { lists, folders, loading, deleteList, duplicateList, updateList, bulkDeleteLists } = useLists()
  ...
  const filteredLists = useMemo(() => {
    ...
    return filtered
  }, [lists, statusFilter, priorityFilter, searchTerm])
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[oklch(0.14_0.00_0)]">
            ...
            <div className="flex items-center gap-4">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="outline" 
                    className="h-9 px-3 bg-[oklch(0.99_0.00_0)] hover:bg-[oklch(0.95_0.00_0)] border-[oklch(0.92_0.00_0)] dark:bg-[oklch(0.20_0.00_0)] dark:hover:bg-[oklch(0.14_0.00_0)] dark:border-[oklch(0.27_0.00_0)] text-[oklch(0.20_0.00_0)] dark:text-[oklch(0.92_0.00_0)] transition-colors duration-200"
                  >
        ...
        <AddToFolderModal
          ...
          onAddToFolder={(listId, folderId) => {
            ...
            toast.success('Liste klasöre eklendi')
            setListToAddToFolder(null)
            setOpenDropdownId(null)
          }}
        />
